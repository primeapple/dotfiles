...
- If you find yourself needing to debug a third-party dependency, clone it into `/tmp` and debug from there rather than modifying anything inside `node_modules` or fetching single files from the remotes api.
