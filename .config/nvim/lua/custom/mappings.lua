...
-- Harpoon
map("n", "gh", function() require('harpoon.mark').toggle_file() end, { silent = true })
map("n", "]h", function() require('harpoon.ui').nav_next() end, { silent = true })
map("n", "[h", function() require('harpoon.ui').nav_prev() end, { silent = true })
map("n", "gH", function() require('harpoon.ui').toggle_quick_menu() end, { silent = true })
