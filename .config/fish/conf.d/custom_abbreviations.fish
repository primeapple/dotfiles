if status --is-interactive
    ...
    for tuples in g,git y,yadm
        ...
        abbr --add --global $abb'gb' $cmd 'git branch'
        abbr --add --global $abb'bd' $cmd 'branch -d'
        abbr --add --global $abb'bm' $cmd 'branch -m'
        abbr --add --global $abb'c' $cmd 'commit -v'
        abbr --add --global $abb'can' $cmd 'commit --amend --no-edit'
        abbr --add --global $abb'cb' $cmd 'checkout -b'
        abbr --add --global $abb'cd' $cmd 'checkout dev'
        abbr --add --global $abb'cm' $cmd 'checkout main'
        abbr --add --global $abb'c-' $cmd- 'checkout -'
        abbr --add --global $abb'co' $cmd 'checkout'
        ...
        abbr --add --global $abb'rbd' $cmd 'rebase dev'
        abbr --add --global $abb'rbm' $cmd 'rebase main'
