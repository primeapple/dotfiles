if status --is-interactive
    ...
    for tuples in g,git y,yadm
        ...
        abbr --add $abb'rb' $cmd 'rebase'
        abbr --add $abb'rba' $cmd 'rebase --abort'
        abbr --add $abb'rbc' $cmd 'rebase --continue'
        abbr --add $abb'rc' $cmd 'recent'
        ...
        abbr --add $abb'pf' $cmd 'push --force'
